...
Open [SQE Developer Hub](SQE_DEVELOPER_HUB.html) for current navigation and [Current Development State](DEV_STATE.md) for status.

The [full Vortex brief](LOCAL_HOME/sqe-private/handoffs/2026-09-23-vortex-full-review-brief.md) requests independent mobile alternatives and delivery sequencing. The [code/evidence index](docs/ace/CODE-AND-EVIDENCE-INDEX.md) distinguishes current implementation, historical maps and acceptance evidence. No migration is approved.
...
The owner-authorised public Zauner showcase is now published separately at https://zauner-ims-review.alan-richardson.chatgpt.site/. Its static source is outside this repository. It does not expose the Python workbench or establish its operational readiness.
The Python workbench contains authenticated write routes. Its existing data controls are unchanged. Raw emails, private evidence, internal records and signing material are not part of the published showcase.
...
| Development-state and hub pages | Current summaries now identify this workspace; earlier records remain labelled historical |
...
Remaining work includes dirty-file reconciliation, held import decisions, web readiness and a decision on how the Zauner presentation becomes an operational workflow.
...
The owner has reopened alternative mobile approaches for investigation. Historical Swift-only instructions are retained as evidence, not as a restriction on that review. No alternative has been selected or implemented.
