...
- Controlled workflow: `ace-ios-client-phase6-1-controlled-evidence`.
...
Store logs, XCTest result bundles, and fictional PNG files below `sqe/ios/ACEClientApp/build/phase6-1/`.
