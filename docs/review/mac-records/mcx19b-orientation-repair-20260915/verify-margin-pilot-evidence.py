...
run=stage/'margin-pilot-runs/20260915T100107Z-pilot-a8d5a906fdf3'
...
execution=json.loads((stage/'margin-pilot-execution.json').read_text())
...
with (stage/'margin-pilot-native-integrity.json').open('x') as stream:json.dump(record,stream,indent=2)
