...
e=base/'functional-after-fixture-parity';e.mkdir(mode=0o700,exist_ok=False)
passedPath=base/'ace-ios-local-runs/20260914T100030Z-selected-de52076afee0/manifest.json'
