...
enum UITestScenario: String {
    ...
    case keychainRead, keychainWrite, keychainDeletion, deletionOnly, deletionRetry, copyConfirmation, privacy, minimalAuditRepro
...
struct ScenarioRootView: View {
    ...
    var body: some View {
        ...
        case .minimalAuditRepro: MinimalAuditReproView()
        }
    }
}
#endif
