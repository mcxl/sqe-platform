...
Latest diagnostic: see NATIVE_LIST_TRIAL_STATUS.md. Standard List trial failed and was not adopted. Main source stays clean at 1b38b90.


Current checkpoint: 15 September 2026. See [Complete Action Copy Status](ACTION_COPY_STATUS.md).

The records below are historical. The linked checkpoint supersedes source, Copy contract, current counts and device-access status.
