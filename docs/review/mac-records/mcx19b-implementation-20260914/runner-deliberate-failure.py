...
backup=base/'runner-deliberate-original-test.swift'
...
try:
    ...
    with (base/'runner-deliberate-failure.log').open('w') as out:
    ...
    (base/'runner-deliberate-failure.json').write_text(json.dumps(record,indent=2))
