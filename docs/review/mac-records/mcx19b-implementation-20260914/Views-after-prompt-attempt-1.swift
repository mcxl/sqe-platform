...
struct SignInView: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                TextField("Username", text: $username, prompt: Text("Username").foregroundStyle(.primary))
                    .textInputAutocapitalization(.never)
                    .accessibilityLabel("Username")
                SecureField("Password", text: $password, prompt: Text("Password").foregroundStyle(.primary))
                    .textInputAutocapitalization(.never)
