...
e=base/'functional-all-current';e.mkdir(mode=0o700,exist_ok=False)
passedPath=base/'ace-ios-local-runs/20260914T084144Z-selected-d53d2186439c/manifest.json'
