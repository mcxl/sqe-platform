...
- Keep the delivery checkout `LOCAL_HOME/Developer/sqe-platform-release-layout` untouched. Work in a separate diagnostic worktree.
...
`LOCAL_HOME/ace-private/mcx19b-orientation-repair-20260915`
...
| Evidence output | `LOCAL_HOME/ace-private/mcx19b-orientation-repair-20260915/14-copy-reflow-check-20260917/` |

The existing worktree `LOCAL_HOME/Developer/sqe-platform-r5-diagnostic` holds the D1 patch as an uncommitted modification. Do not build on it in place. Create a new worktree at `52b212a` for D2, or restore the r5 worktree to clean first and record that restoration.
